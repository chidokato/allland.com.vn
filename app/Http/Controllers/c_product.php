...
class c_product extends Controller
{
    ...
    public function postadd(Request $Request)
    {
        ...
        $product->tab1 = $Request->tab1;
        $product->tab2 = $Request->tab2;
        $product->tab3 = $Request->tab3;
        $product->tab4 = $Request->tab4;
        $product->tab5 = $Request->tab5;
        $product->tab6 = $Request->tab6;
        $product->tab7 = $Request->tab7;
        $product->tab8 = $Request->tab8;
        $product->tab9 = $Request->tab9;
        ...
        $product->heading8 = $Request->heading8;
        $product->heading9 = $Request->heading9;
        ...
        $product->content8 = $Request->content8;
        $product->content9 = $Request->content9;
        // seo
    ...
    public function getedit($id)
    {
        ...
        $category = category::where('sort_by',1)->orderBy('id','desc')->get();
        $product_images = product_images::where('p_id',$data->id)->where('note','0')->orderBy('id','desc')->get();
        $city = city::all();
	...
	// add section
	public function getsection($pid)
    {
		$imadetail = product_images::where('p_id',$pid)->orderBy('id','desc')->get();
	...
	public function addsection(Request $Request, $pid)
	{
		$product_images = new product_images;
        $product_images->p_id = $pid;
        $product_images->note = $Request->note;
        $product_images->name = $Request->name;
        $product_images->section = $Request->section;
        $product_images->content = $Request->content;
        $product_images->img = $Request->img;
		
		$product_images->save();
		return redirect('admin/product/section/'.$pid)->with('Alerts','Thành công');
	}
	
	public function delsection($pid, $id)
    {
