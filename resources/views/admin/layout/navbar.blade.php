    ...
    <div class="navbar-default sidebar" id="scroll" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li><a href="admin/order/list"><i class="fa fa-dashboard fa-fw"></i> Order ({{$count_order}})</a></li>
                ...
                <li><a href="admin/comment/list"><i class="fa fa-table fa-fw"></i> Comment</a></li>
