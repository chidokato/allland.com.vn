                ...
                <table width="100%" id="dataTables-example" class="table table-striped table-bordered table-hover" >
					...
					<tbody>
						...
						<tr class="img">
							...
							<td class="img"><img style='width: 70px;object-fit: cover;' src="data/news/80-60/{{$val->img}}"></td>
							<td><a target="_blank" href='{{$val->category->slug}}/{{$val->slug}}/{{$val->id}}.html'>{{$val->name}}</a></td>
