		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-12">
	                    <label>Slug</label>
                        <input value="{{$data->slug}}" name='slug' type="text" placeholder="slug ..." class="form-control ">
	                </div>
		        	<div class="col-md-12">
			            <label>Detail</label>
	            		...
	            		<label>Content</label>
	            		<textarea name="content" class="form-control ckeditor">{{$data->content}}</textarea>
		        	</div>
              	</div>
			</div>
		</div>
...
<style>.cke_contents{height: 400px !important;}</style>
@endsection