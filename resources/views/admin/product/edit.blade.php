...
<div class="row">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
                ...
                <ul class="nav nav-tabs">
					<li class="active">
                    	<a href="#mota" data-toggle="tab">Mô tả</a>
                    </li>
					<li>
                    	<a href="#chinhsach" data-toggle="tab">Chính sách</a>
                    </li>
                    @for ($i = 1; $i <= 8; $i++)
                    <li>
					...
					<div class="tab-pane fade in active" id="mota">
                        <div class="row">
				        	<div class="col-md-12">
			            		...
			            		<textarea name="detail" class="form-control ckeditor">{!!$data->detail!!}</textarea>
				        	</div>
		              	</div>
                    </div>
					<div class="tab-pane fade in" id="chinhsach">
                        <div class="row">
							<div class="col-md-3">
			                    <label>Tab</label>
		                        <input value="<?php echo $data['tab9']; ?>" name='tab9' type="text" placeholder="tab ..." class="form-control ">
			                </div>
							<div class="col-md-9">
			                    <label>Tiêu đề</label>
		                        <input value="<?php echo $data['heading9']; ?>" name='heading9' type="text" placeholder="Heading ..." class="form-control ">
			                </div>
				        	<div class="col-md-12">
					            <label>Nội dung</label>
			            		<textarea name="content9" class="form-control ckeditor"><?php echo $data['content9']; ?></textarea>
				        	</div>
		              	</div>
                    </div>
                    @for ($i = 1; $i <= 8; $i++)
                    <div class="tab-pane fade in" id="Section{{$i}}">
                        <div class="row">
							<div class="col-md-3">
			                    <label>tab</label>
		                        <input value="<?php echo $data['tab'.$i]; ?>" name='tab{{$i}}' type="text" placeholder="tab ..." class="form-control ">
			                </div>
							<div class="col-md-9">
			                    <label>Tiêu đề</label>
				        	...
				        	<div class="col-md-12">
					            <label>Nội dung</label>
			            		<textarea name="content{{$i}}" class="form-control ckeditor"><?php echo $data['content'.$i]; ?></textarea>
				        	</div>
		              	</div>
                    </div>
                    @endfor
	...
	<div class="col-md-3 col-sm-3 col-xs-3">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<a target='_blank' href='admin/product/section/{{$data->id}}'>Nâng cao</a>
			</div>
		</div>
	</div>
</div>
