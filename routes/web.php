...
Route::group(['prefix'=>'admin','middleware'=>'adminlogin'],function(){
	...
	Route::group(['prefix'=>'product'],function(){
		...
		// detail product
		Route::get('section/{pid}','c_product@getsection');
		Route::post('addsection/{pid}','c_product@addsection');
		Route::get('delsection/{pid}/{id}','c_product@delsection');
	...
	Route::group(['prefix'=>'comment'],function(){
		Route::get('list','c_comment@getlist');
		Route::get('edit/{id}','c_comment@getedit');
		Route::post('edit/{id}','c_comment@postedit');
		Route::get('delete/{id}','c_comment@getdelete');
	});
...
Route::get('about','c_frontend@about');
Route::get('lien-he','c_frontend@contact');
Route::get('sitemap','c_frontend@map');
Route::get('iframe','c_frontend@iframe');
Route::POST('comment','c_frontend@comment');
